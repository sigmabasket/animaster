...
function addListeners() {
    ...
    document.getElementById('customAnimationPlay1')
        .addEventListener('click', function () {
            const block = document.getElementById('customAnimationBlock1');
            customAnimation.play(block);
        });

    document.getElementById('customAnimationPlay2')
        .addEventListener('click', function () {
            const block = document.getElementById('customAnimationBlock2');
            customAnimation.play(block);
        });
}
